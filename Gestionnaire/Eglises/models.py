...
class Eglise(models.Model):
    ...
    coordinatrice_des_femmes = models.CharField(max_length=100, blank=True)
    dirigeant_de_zone1 = models.CharField(max_length=100, blank=True)
    dirigeant_de_zone2 = models.CharField(max_length=100, blank=True)
    responsable_des_femmes1 = models.CharField(max_length=100, blank=True)
    responsable_des_femmes2 = models.CharField(max_length=100, blank=True)
    responsable_des_jeunes_femme = models.CharField(max_length=100, blank=True)
    responsable_des_jeunes_professionnel = models.CharField(max_length=100, blank=True)
    region = models.CharField(max_length=100)
